...
def evaluate_model(model_path, X_test_path, y_test_path, output_path, model_type):
    ...
    #with Live() as live:
    #    live.log_sklearn_plot("confusion_matrix", y_test, predictions, name = f"{model_type}_cm.json")
...
if __name__ == '__main__':
    ...
    evaluate_model(model_path, X_test_path, y_test_path, output_path, model_type)