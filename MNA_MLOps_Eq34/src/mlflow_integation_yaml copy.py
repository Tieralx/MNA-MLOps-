...
with open("MNA_MLOps_Eq34/src/test_params.yaml") as config_file:
...
class CervicalCancerModel:
    ...
    def train_model_with_grid_search(self):
        ...
        grid_search = GridSearchCV(self.model_pipeline, param_grid, cv=config_params["grid_search"]["cv"], scoring='accuracy')
